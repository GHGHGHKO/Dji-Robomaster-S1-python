...
def start():
    ...
    #move_Turn(100, 10, 'right', 0.5)

    #move_Turn_v3(100, 90, 'right', 0.5)
    #move_Turn(150, 10, 'right', 0.5)
    ...
    chassis_ctrl.move_with_distance(40, 0.7)

    robot_ctrl.set_mode(rm_define.robot_mode_chassis_follow)    
    #line_Center(3)
    start_point_x = chassis_ctrl.get_position_based_power_on(rm_define.chassis_forward)
    start_point_y = chassis_ctrl.get_position_based_power_on(rm_define.chassis_translation)
    print('start_point_x', start_point_x)
    print('start_point_y', start_point_y)

    robot_ctrl.set_mode(rm_define.robot_mode_free)

    position_y(-90, 0, 0.3, 2.5) 
    print(detected_Num[2])

    move_Turn(150, 5, 'right', 0.5)
    robot_ctrl.set_mode(rm_define.robot_mode_free)
    point_01_x = chassis_ctrl.get_position_based_power_on(rm_define.chassis_forward)
    point_01_y = chassis_ctrl.get_position_based_power_on(rm_define.chassis_translation)
    print('point_01_x', point_01_x)
    print('point_01_y', point_01_y)

    sort_Dic[detected_Num[2]] = [point_01_x, point_01_y, 'point_0']
    print(sort_Dic)

    position_y(-90, 0, 0.3, 2.7)
    print(detected_Num[3])
    move_Turn(150, 5, 'right', 0.5)
    robot_ctrl.set_mode(rm_define.robot_mode_free)
    point_02_x = chassis_ctrl.get_position_based_power_on(rm_define.chassis_forward)
    point_02_y = chassis_ctrl.get_position_based_power_on(rm_define.chassis_translation)
    print('point_02_x', point_02_x)
    print('point_02_y', point_02_y)

    sort_Dic[detected_Num[3]] = [point_02_x, point_02_y, 'point_0']

    #position_y(-30, 0, 0.3, 2.5)
    #point_03 = chassis_ctrl.get_position_based_power_on(rm_define.chassis_forward)
    #print('point_03')

    chassis_ctrl.move_with_distance(0, 0.8)
    vision_Select(3, 0.25, 3, 15)
    move_Turn(150, 90, 'right', 0.5)

    robot_ctrl.set_mode(rm_define.robot_mode_free)

    #media_ctrl.zoom_value_update(2)
    position_y(-90, 0, 0.3, 2.4)
    print(detected_Num[4])
    #media_ctrl.zoom_value_update(1)
    point_13_x = chassis_ctrl.get_position_based_power_on(rm_define.chassis_forward)
    point_13_y = chassis_ctrl.get_position_based_power_on(rm_define.chassis_translation)
    print('point_13_x', point_13_x)
    print('point_13_y', point_13_y)
    print('dic_insert_null', dic_insert_null)

    sort_Dic[detected_Num[4]] = [point_13_x, point_13_y, 'point_13']

    #position_y(-55, 0, 0.3, 2.5)
    #point_23 = chassis_ctrl.get_position_based_power_on(rm_define.chassis_forward)
    #print('point_23')

    chassis_ctrl.move_with_distance(0, 0.2)
    vision_Select(3, 0.3, 3, 47)
    media_ctrl.zoom_value_update(1)
    move_Turn(150, 45, 'right', 0.5)
    move_Turn_v5(50, -174)

    robot_ctrl.set_mode(rm_define.robot_mode_free)

    position_y(-90, 0, 0.3, 2.3)
    print(detected_Num[5])
    move_Turn(150, 5, 'right', 0.5)
    robot_ctrl.set_mode(rm_define.robot_mode_free)
    point_22_x = chassis_ctrl.get_position_based_power_on(rm_define.chassis_forward)
    point_22_y = chassis_ctrl.get_position_based_power_on(rm_define.chassis_translation)
    print('point_22_x', point_22_x)
    print('point_22_y', point_22_y)
    print('dic_insert_null', dic_insert_null)

    sort_Dic[detected_Num[5]] = [point_22_x, point_22_y, 'point_2']

    position_y(-90, 0, 0.3, 2.3)
    print(detected_Num[6])
    #move_Turn(150, 5, 'right', 0.5)
    robot_ctrl.set_mode(rm_define.robot_mode_free)
    point_21_x = chassis_ctrl.get_position_based_power_on(rm_define.chassis_forward)
    point_21_y = chassis_ctrl.get_position_based_power_on(rm_define.chassis_translation)
    print('point_21_x', point_21_x)
    print('point_21_y', point_21_y)

    sort_Dic[detected_Num[6]] = [point_21_x, point_21_y, 'point_2']

    #position_y(-45, 0, 0.3, 2.3)
    #point_20 = chassis_ctrl.get_position_based_power_on(rm_define.chassis_forward)
    #print('point_20')
    ...
    #media_ctrl.zoom_value_update(2)
    position_y(-90, 0, 0.3, 2)
    print(detected_Num[7])
    #media_ctrl.zoom_value_update(1)
    point_10_x = chassis_ctrl.get_position_based_power_on(rm_define.chassis_forward)
    point_10_y = chassis_ctrl.get_position_based_power_on(rm_define.chassis_translation)
    print('point_10_x', point_10_x)
    print('point_10_y', point_10_y)

    sort_Dic[detected_Num[7]] = [point_10_x, point_10_y, 'point_10']
    ...
    #chassis_ctrl.move_with_distance(180, abs(sort_Dic[14][0] - start_point_x))
    current_Point_x = start_point_x
    current_Point_y = start_point_y

    there_To_Go_x = sort_Dic[11][0]
    there_To_Go_y = sort_Dic[11][1]

    if there_To_Go_x - current_Point_x < 0:
        chassis_ctrl.move_with_distance(180, abs(there_To_Go_x - current_Point_x))
    else:
        chassis_ctrl.move_with_distance(0, abs(there_To_Go_x - current_Point_x))

    if there_To_Go_y - current_Point_y < 0:
        chassis_ctrl.move_with_distance(-90, abs(there_To_Go_y - current_Point_y))
    else:
        chassis_ctrl.move_with_distance(90, abs(there_To_Go_y - current_Point_y))

    shoot(11)

    current_Point_x = sort_Dic[11][0]
    current_Point_y = sort_Dic[11][1]

    there_To_Go_x = sort_Dic[12][0]
    there_To_Go_y = sort_Dic[12][1]
    ...
    current_Point_x = sort_Dic[12][0]
    current_Point_y = sort_Dic[12][1]

    there_To_Go_x = sort_Dic[13][0]
    there_To_Go_y = sort_Dic[13][1]
    ...
    current_Point_x = sort_Dic[13][0]
    current_Point_y = sort_Dic[13][1]

    there_To_Go_x = sort_Dic[14][0]
    there_To_Go_y = sort_Dic[14][1]
