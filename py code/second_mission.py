...
def start():
    ...
    result = user_defined_Save_Modified()
    user_defined_Save()

    move_Turn(200, 90, 'right', 0.5)
    move_Axis(0.3, -55, 0.8, 0.5)

    line_Center(3)
    line_Num = user_defined_Save_Modified()
    ...
    elif result != line_Num:
        move_Axis(0.3, 0, 0.3, 0.5)
        move_Axis(0.3,90,1,0.5)
