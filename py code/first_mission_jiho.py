...
def start():
    ...
    while not cnt == 1:
        ...
        if result == second_result:
            if result == 1:
                line_Tracking_v3(0.4, 'red')
                cnt = 1

            if result == 2:
                line_Tracking_v3(0.4, 'green')
                cnt = 1

            if result == 3:
                line_Tracking_v3(0.4, 'blue')
                cnt = 1
